...
class ViewController : UIViewController {
    ...
    private func setupUI() {
        ...
        let stack = UIStackView(arrangedSubviews: [usernameTextField, passwordTextField, mobileNumberTextField, addressTextField, loginButton, signupButton])
        stack.axis = .vertical
        stack.spacing = 15
    ...
    @objc private func handleSignup() {
        ...
        let mobileNum = mobileNumberTextField.text
